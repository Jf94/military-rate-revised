...
merge m:1 year using "${DIR_DATA_RAW}/federle/deflator_longrun.dta", nogen keep(master matched)
gen milex = milex_cur * conv_USD_cur_to_2015

drop milex_cur

save "${DIR_DATA_PROCESSED}/shortrun/milex.dta", replace
